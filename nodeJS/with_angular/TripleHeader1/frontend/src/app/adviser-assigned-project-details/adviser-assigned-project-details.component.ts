...
@Component({
  selector: 'app-adviser-assigned-project-details',
  templateUrl: './adviser-assigned-project-details.component.html',
  styleUrls: ['./adviser-assigned-project-details.component.css']
})
export class AdviserAssignedProjectDetailsComponent implements OnInit {
